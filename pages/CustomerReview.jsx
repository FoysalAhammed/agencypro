     ...
     <div class="customer_satisfaction" id='customerSatisfactions' >
        <div class="container">
          <div class="customer_sat_cont">
            ...
            <div class="left_customer_satis">
              <h3>CUSTOMER SATISFACTION GUARANTED</h3>
              <h2>Efficient Help,<br />
              Every Step of the Way.</h2>
              <p>Get the support you need from out ticket center,
              ...
              <div class="support_team">
                ...
                <div>
                  ...
                  <div class="support_stars">
                    ...
                    stroke-width="0" version="1.2" baseprofile=
                    "tiny" viewbox="0 0 24 24" height="1em" width=
                    "1em" xmlns="http://www.w3.org/2000/svg">
                    <path d=
                    ...
                    </path></svg><svg stroke="currentcolor" fill=
                    "currentcolor" stroke-width="0" version="1.2"
                    baseprofile="tiny" viewbox="0 0 24 24" height=
                    "1em" width="1em" xmlns=
