        ...
        <div class="container">
          <div class="pages_right_sec_cont">
            <div class="left_pages_name_title">
              ...
              <a href="#innerpages" className={activeTab === 'innerpages' ? 'active' : ''}
               onClick={(e)=>hadleTabChange('innerpages',e)}>
                Inner Pages
              </a>
              <a href="#portfolio" className={activeTab === 'portfolio' ? 'active' : ''}
               onClick={(e)=>hadleTabChange('portfolio',e)}>
                Portfolio
              </a>
              <a href="#shop" className={activeTab === 'shop' ? 'active' : ''}
               onClick={(e)=>hadleTabChange('shop',e)}>
                Shop Pages
              </a>
              <a href="#blog" className={activeTab === 'blog' ? 'active' : ''}
